\week[description={This week discusses systems that follow rules. If there are systems that follow rules, we can compute with them. Many systems that seem simple are actually capable of universal computation.}]{Things That Follow Rules}

Rules are all around us. Some rules are set by nature. Others are made
by people.
...
different ways.
\didyouknow{
  You can play Turing Tumble on a computer at the website
  \resource[qrcode,is url,kind={Resources},description={Play the Turing Tumble game online.}]{https://jessecrossen.github.io/ttsim}.
}
...
\begin{DeepDiveBox}
  ...
  \margmark{play-life}{\curiousboxtext You can play the game of life by going to
    \resource[qrcode,is url,kind={Resources},description={Online Game of Life simulator.}]{https://playgameoflife.com}.}
