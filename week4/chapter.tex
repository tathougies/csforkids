...
\begin{TryThisBox}
  ...
  \tikzforeground{
    ...
    \node[anchor=south west] (instrument decoration note) at ([yshift=0.5em, xshift=12em]instrument decoration){
    ...
    \draw[->] (instrument decoration note.west) to[out=180,in=180,looseness=0.8] (instrument decoration);
    }
\begin{lstlisting}
