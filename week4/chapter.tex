...
\begin{replbox}
from week4.examples as *<ENTER>
import week4.synth as synth<ENTER>
\end{replbox}
...
\begin{table*}[t]
  ...
  \begin{tabular}{p{0.2\textwidth}p{0.7\textwidth}}
    ...
    \bottomrule
  \end{tabular}
  \caption{\vspace{1em} More functions you can use to manipulate instrument voices. Pay attention to the arguments to the functions.}
  \label{tab:synths}
\end{table*}
...
\item The program in \code{week4/hear.py} can record audio in real-time and display a function that
