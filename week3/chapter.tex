...
\mTrackBox{Security}{Cyber-security is highly dependent on understanding how complex algorithms
  ...
  key have to use an algorithm that can be proven to take longer than the age of the
...
\begin{DeepDiveBox}
  \boxtitle{Programming Languages}
  \label{deepdive:programming-languages}

  At the beginning of this course we discussed already how 
\end{DeepDiveBox}
