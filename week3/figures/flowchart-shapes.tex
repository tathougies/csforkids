\begin{tikzpicture}[>=latex']
  \begin{scope}[minimum width=2cm, minimum height=0.5cm]
    ...
    \node[anchor=north] at ([yshift=-1.5em]terminal) {
      \begin{tcolorbox}[code note, width=3.5cm]
        The pill box represents where an algorithm starts or ends.
      \end{tcolorbox}
    };

    \node (predproc) at (4, 8) [draw, predproc] {Function};
    \node[anchor=north] at ([yshift=-1.5em]predproc) {
      \begin{tcolorbox}[code note, width=3.5cm]
        This shows a function being called
      \end{tcolorbox}
    };

    \node(decision) at (0, 4) [draw, decision, yscale=0.8] {\code{x == '*'}};
    \node[anchor=north] at ([yshift=-2.5em]decision) {
      \begin{tcolorbox}[code note, width=3.5cm]
    ...
    \node [anchor=north] at ([yshift=-1.5em]process) {
      \begin{tcolorbox}[code note, width=3.5cm]
