...
\newcommand{\aside}[1]{\marginnote{\raggedright\sffamily\footnotesize #1}}
\newcommand{\curious}[1]{\marginnote{\raggedright\sffamily\footnotesize\textbf{\textcolor{DeepPurple}{Curious? }}#1}}
\newcommand{\didyouknow}[1]{\marginnote{\raggedright\sffamily\footnotesize\textbf{\textcolor{IdeaBlue}{Did You Know? }}#1}}
\newcommand{\hint}[1]{\marginnote{\raggedright\sffamily\footnotesize\textbf{\textcolor{TryGreen}{Hint} }#1}}
\newcommand{\huh}[2]{\marginnote{\raggedright\sffamily\footnotesize\textbf{\textcolor{HuhRed}{Confused?}}\\\textbf{#1}\\#2}}
